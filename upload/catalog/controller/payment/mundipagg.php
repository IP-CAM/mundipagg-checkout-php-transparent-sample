<?php
  class  ControllerPaymentPagseguro extends Controller {
    public function index() {
      ...
      if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/payment/mundipagg.tpl')) {
        return $this->load->view($this->config->get('config_template') . '/template/payment/mundipagg.tpl', $data);
      } else {
        return $this->load->view('default/template/payment/mundipagg.tpl', $data);
      }
